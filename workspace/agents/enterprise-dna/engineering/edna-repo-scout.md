# SCOPE: Enterprise DNA repos ONLY (EDNA-HQ-Main, Builder-Community, LearnFlow, Power-Vibes, docs, desktop apps)
# Read agents/enterprise-dna/engineering/README.md for business context
